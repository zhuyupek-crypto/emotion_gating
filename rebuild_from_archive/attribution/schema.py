...
BRANCHES = ["YJJ", "Scorpion", "RZQ", "ZB", "Auction"]

SCAN_STATUS_VALUES = [
    "EXECUTED",
    "EXECUTED_EMPTY",
    "NOT_CALLED_BY_CONTROL_FLOW",
    "EARLY_RETURN_NO_SOURCE",
    "SOURCE_ERROR",
    "SOURCE_LIMITED",
]
...
SOURCE_MODES = [
    ...
    "HISTORY_FALLBACK",
    "BILLBOARD_API",
    "DAILY_PRICE_COMPUTED",
    "PROJECT_AUCTION_PREPARE_CACHE",
    "AUCTION_PREPARE_COMPUTED",
    "NOT_APPLICABLE",
]

SOURCE_COVERAGE_VALUES = ["COMPLETE_ACTUAL_PATH", "PREPARED_ONLY", "UNKNOWN", "NOT_RUN"]
RAW_RECORD_TYPES = ["OBSERVED_RAW_PATTERN", "SOURCE_LIMITED_PREPARED_RECORD"]
RAW_SCAN_TERMINALS = ["PREPARED", "SCAN_FILTERED", "DATA_INVALID", "CAPPED_OUT", "SOURCE_LIMITED", "UNRESOLVED"]
