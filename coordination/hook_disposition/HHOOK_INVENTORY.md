...
- Hook total: `33`
- By semantic_type: `{"data_correction": 10, "jq_platform_behavior": 10, "market_rule": 2, "project_logic": 7, "unknown": 4}`
- By disposition: `{"archive_jq_only": 11, "investigate": 8, "move_to_hdata": 5, "move_to_local_quant": 2, "retain_in_project": 7}`
- By status: `{"archive_candidate": 11, "handoff_pending": 7, "investigation_pending": 8, "retain": 7}`
...
- Hooks still requiring investigation: `8`
...
### 8. 建立local-native模式时，建议先关闭哪一组？
- `execution.execution_price_anomalies`
- `execution.fill_amount_anomalies`
- `execution.order_amount_anomalies`
- `market_data.minute_price_anomalies`

### 9. 哪些钩子必须等待local_quant能力完成后才能删除？
- `engine.immediate_sell_cash_release`
- `instrument_fallbacks.zero_fee_overrides`

### 10. 哪些钩子必须等待HData发布修复版本后才能删除？
- `instrument_fallbacks.price_fallbacks`
- `market_data.corrupted_daily_limit_windows`
- `security_metadata.adjust_extras_is_st`
- `security_metadata.non_st_name_windows`
...
| hook_id | semantic_type | disposition | status | years | codes | runtime call sites | target_owner |
| --- | --- | --- | --- | --- | --- | ---: | --- |
| `engine.immediate_sell_cash_release` | `market_rule` | `move_to_local_quant` | `handoff_pending` | `` | `` | `2` | `local_quant` |
| `market_data.corrupted_daily_limit_windows` | `data_correction` | `move_to_hdata` | `handoff_pending` | `` | `` | `12` | `hdata` |
| `market_data.tail_seal_anomalies` | `unknown` | `investigate` | `investigation_pending` | `2020,2021,2022,2025` | `000420.XSHE,002487.XSHE,300118.XSHE,600711.XSHG,603031.XSHG` | `3` | `investigation` |
| `market_data.minute_price_anomalies` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `2020,2021,2022,2023,2024,2025,2026` | `000592.XSHE,000987.XSHE,002056.XSHE,002130.XSHE,002176.XSHE,002229.XSHE` | `2` | `jq_archive` |
| `market_data.daily_ipo_close_anomalies` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `2020` | `605123.XSHG,605255.XSHG,605369.XSHG,605399.XSHG` | `3` | `jq_archive` |
| `market_data.daily_field_anomalies` | `data_correction` | `investigate` | `investigation_pending` | `2020,2021,2022,2024,2025,2026` | `000420.XSHE,002121.XSHE,002141.XSHE,002185.XSHE,002256.XSHE,002265.XSHE` | `4` | `investigation` |
| `execution.preopen_reject_cash_below` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `2025` | `` | `2` | `jq_archive` |
| `execution.preopen_reject_orders` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `` | `` | `2` | `jq_archive` |
| `execution.preopen_drop_first_duplicate` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `2021,2022` | `000547.XSHE,000600.XSHE,002120.XSHE,002508.XSHE,600072.XSHG,603589.XSHG` | `2` | `jq_archive` |
| `execution.execution_price_anomalies` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `2020,2023` | `000034.XSHE,000049.XSHE,000505.XSHE,000592.XSHE,000650.XSHE,000700.XSHE` | `2` | `jq_archive` |
| `execution.order_amount_anomalies` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `2020` | `000592.XSHE,000700.XSHE,000800.XSHE,000859.XSHE,000987.XSHE,002022.XSHE` | `2` | `jq_archive` |
| `execution.fill_amount_anomalies` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `2020` | `002041.XSHE,600086.XSHG` | `2` | `jq_archive` |
| `call_auction.empty_anomalies` | `data_correction` | `investigate` | `investigation_pending` | `2020,2021` | `002897.XSHE,600804.XSHG,600982.XSHG,603908.XSHG` | `2` | `investigation` |
| `call_auction.allow_only` | `data_correction` | `investigate` | `investigation_pending` | `2021` | `000833.XSHE` | `2` | `investigation` |
| `call_auction.depth_overrides` | `data_correction` | `investigate` | `investigation_pending` | `2020,2021` | `000038.XSHE,002635.XSHE` | `2` | `investigation` |
| `security_metadata.start_date_overrides` | `data_correction` | `move_to_hdata` | `handoff_pending` | `` | `605123.XSHG,605255.XSHG,605369.XSHG,605399.XSHG` | `2` | `hdata` |
| `security_metadata.non_st_name_windows` | `data_correction` | `move_to_hdata` | `handoff_pending` | `1900,2020,2021,2022,2023,2024,2025,2026` | `000506.XSHE,000584.XSHE,000585.XSHE,000673.XSHE,000839.XSHE,000980.XSHE` | `2` | `hdata` |
| `security_metadata.special_display_name_rules` | `unknown` | `investigate` | `investigation_pending` | `2020,2022` | `001270.XSHE,600856.XSHG` | `2` | `investigation` |
| `security_metadata.adjust_extras_is_st` | `data_correction` | `move_to_hdata` | `handoff_pending` | `2020,2024` | `600856.XSHG` | `2` | `hdata` |
| `security_metadata.billboard_row_filters` | `data_correction` | `investigate` | `investigation_pending` | `2020,2022` | `600146.XSHG,603721.XSHG` | `2` | `investigation` |
| `instrument_fallbacks.price_fallbacks` | `data_correction` | `move_to_hdata` | `handoff_pending` | `2024` | `511880.XSHG` | `2` | `hdata` |
| `instrument_fallbacks.zero_fee_overrides` | `market_rule` | `move_to_local_quant` | `handoff_pending` | `` | `511880.XSHG` | `8` | `local_quant` |
| `strategy_state.fb_state_overrides` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `2020` | `` | `4` | `jq_archive` |
| `strategy_state.v227_shock_overrides` | `jq_platform_behavior` | `archive_jq_only` | `archive_candidate` | `2023` | `` | `4` | `jq_archive` |
| `project_feature.first_seal_loader` | `project_logic` | `retain_in_project` | `retain` | `` | `` | `4` | `emotion_gating_project` |
| `project_feature.board_snapshot_accessor` | `project_logic` | `retain_in_project` | `retain` | `` | `` | `6` | `emotion_gating_project` |
| `project_feature.master_prepare_index_accessor` | `project_logic` | `retain_in_project` | `retain` | `` | `` | `4` | `emotion_gating_project` |
| `project_feature.auction_yiqian_prepare_accessor` | `project_logic` | `retain_in_project` | `retain` | `` | `` | `5` | `emotion_gating_project` |
| `project_feature.call_auction_day_loader` | `project_logic` | `retain_in_project` | `retain` | `` | `` | `2` | `emotion_gating_project` |
| `project_feature.strategy_namespace_bridge` | `project_logic` | `retain_in_project` | `retain` | `` | `` | `4` | `emotion_gating_project` |
| `engine.checkpoint_resume_hook` | `project_logic` | `retain_in_project` | `retain` | `` | `` | `6` | `emotion_gating_project` |
| `legacy.public_data_api_shim` | `unknown` | `investigate` | `investigation_pending` | `` | `` | `0` | `emotion_gating_project` |
| `legacy.temporary_fallbacks_shim` | `unknown` | `archive_jq_only` | `archive_candidate` | `` | `` | `0` | `jq_archive` |
...
- Secondary references: `alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:302:+            if getattr(self.compat, "immediate_sell_cash_release", False):; tools\audit_hook_disposition.py:253:        hook_id="engine.immediate_sell_cash_release",; tools\audit_hook_disposition.py:255:        symbol="EmotionGateJQCompat.immediate_sell_cash_release",; tools\audit_hook_disposition.py:256:        data_obj={"immediate_sell_cash_release": True},; tools\audit_hook_disposition.py:262:        evidence="rebuild_from_archive/project_compat.py sets immediate_sell_cash_release=True and engine/core.py consumes it in the sell-fill cash path.",; tools\audit_hook_disposition.py:271:        delete_requirement="Delete when engine/core.py no longer checks compat.immediate_sell_cash_release and the policy lives in local_quant.",; tools\audit_hook_disposition.py:272:        acceptance_test="Inventory-only: verify engine/core.py still references immediate_sell_cash_release and classify it as local_quant-owned.",; tools\audit_hook_disposition.py:274:        call_site_patterns=["immediate_sell_cash_release"],; tools\audit_hook_disposition.py:1181:        and row["hook_id"] != "engine.immediate_sell_cash_release"`
...
- semantic_type / disposition / status: `data_correction` / `move_to_hdata` / `handoff_pending`
...
- Secondary references: `tools\hook_migration_acceptance.py:166:    def should_bypass_history_fastpath(self, unit, fields, end_dt):; tools\hook_migration_acceptance.py:167:        value = self._base.should_bypass_history_fastpath(unit, fields, end_dt); tools\hook_migration_acceptance.py:561:    bypass_2026 = compat.should_bypass_history_fastpath("1d", ["high", "high_limit"], pd.Timestamp("2026-05-27")); alignment_reports\alignment_configuration_notes.md:116:### 2.7 `should_bypass_history_fastpath(...)`; tools\audit_hook_disposition.py:298:        call_site_patterns=["should_bypass_history_fastpath(", "load_first_seal_year(", "get_project_board_snapshot("],; alignment_reports\alignment_final_report_2020_2026.md:190:  - 提供 `should_bypass_history_fastpath(...)`; alignment_reports\alignment_summary_2020_2026.md:204:- 新增 `should_bypass_history_fastpath(unit, fields, end_dt)`。; alignment_reports\alignment_summary_2020_2026.md:217:- 当 `compat.should_bypass_history_fastpath('daily', fields, day)` 返回 true 时，不再继续快取，直接回退到旧路径。; alignment_reports\alignment_summary_2020_2026.md:205:- `load_first_seal_year()` 在污染窗口跳过对应快缓存。; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:462:+            return self.compat.load_first_seal_year(year); tools\audit_hook_disposition.py:856:        call_site_patterns=["load_first_seal_year(", "get_batch_sealing_points("],; tools\audit_hook_disposition.py:869:        evidence="母版-20260506-Clone.py reads get_project_board_snapshot(context.previous_date) for board scans; engine/data_api.py delegates through compat.",; tools\audit_hook_disposition.py:881:        call_site_patterns=["get_project_board_snapshot("],; alignment_reports\alignment_summary_2020_2026.md:206:- `get_project_board_snapshot()` 在污染窗口直接返回空 `DataFrame()`，避免使用脏首板快照。; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:232:-            'get_project_board_snapshot': lambda *a, **kw: self._wrap_pandas(self.data_api.get_project_board_snapshot(*a, **kw)),; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:465:     def get_project_board_snapshot(self, date):; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:481:+            return self.compat.get_project_board_snapshot(date)`
- target_owner: `hdata`
...
- acceptance_test: tests/test_data_quality_audit.py plus alignment_reports/data_quality_propagation_2026.md
...
- Runtime call sites: `rebuild_from_archive/project_preprocess.py:137:                compat.get_tail_seal_override(f"{date_int:08d}", code); rebuild_from_archive/project_compat.py:114:    def get_tail_seal_override(self, date_key, security):; rebuild_from_archive/engine\data_api.py:851:                self.compat.get_tail_seal_override(day_key, sec)`
- Secondary references: `tools\audit_hook_disposition.py:322:        call_site_patterns=["get_tail_seal_override("],; tools\hook_migration_acceptance.py:161:    def get_tail_seal_override(self, date_key, security):; tools\hook_migration_acceptance.py:162:        value = self._base.get_tail_seal_override(date_key, security)`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:82:    def get_minute_price_override(self, date_key, time_key, security):; rebuild_from_archive/engine\core.py:1119:                override = self.compat.get_minute_price_override(day_key, norm_time, security)`
- Secondary references: `tests\test_compat_entrypoints.py:11:    assert compat.get_minute_price_override("20200114", "11:25", "002056.XSHE") == 10.90; tools\audit_hook_disposition.py:346:        call_site_patterns=["get_minute_price_override("],; tools\hook_migration_acceptance.py:100:    def get_minute_price_override(self, date_key, time_key, security):; tools\hook_migration_acceptance.py:101:        value = self._base.get_minute_price_override(date_key, time_key, security)`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:86:    def get_daily_ipo_close_override(self, security, date_int):; rebuild_from_archive/engine\data_api.py:181:                self.compat.get_daily_ipo_close_override(sec, end_int); rebuild_from_archive/engine\data_api.py:229:                    self.compat.get_daily_ipo_close_override(sec, end_int)`
- Secondary references: `tools\hook_migration_acceptance.py:110:    def get_daily_ipo_close_override(self, security, date_int):; tools\hook_migration_acceptance.py:111:        value = self._base.get_daily_ipo_close_override(security, date_int); tools\hook_migration_acceptance.py:507:        close_override = compat.get_daily_ipo_close_override(case["code"], case["trade_date"]); tools\audit_hook_disposition.py:370:        call_site_patterns=["get_daily_ipo_close_override("],`
- target_owner: `jq_archive`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:90:    def get_daily_field_override(self, security, date_int, field):; rebuild_from_archive/engine\core.py:1211:                        self.compat.get_daily_field_override(code, day_int, field); rebuild_from_archive/engine\data_api.py:167:                self.compat.get_daily_field_override(sec, end_int, field); rebuild_from_archive/engine\data_api.py:222:                    self.compat.get_daily_field_override(sec, end_int, field)`
- Secondary references: `tools\hook_migration_acceptance.py:105:    def get_daily_field_override(self, security, date_int, field):; tools\hook_migration_acceptance.py:106:        value = self._base.get_daily_field_override(security, date_int, field); tools\audit_hook_disposition.py:394:        call_site_patterns=["get_daily_field_override("],`
- target_owner: `investigation`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:104:    def should_reject_preopen_cash(self, date_key, time_key, available_cash):; rebuild_from_archive/engine\core.py:471:            should_reject, cash_threshold = self.compat.should_reject_preopen_cash(`
- Secondary references: `tools\audit_hook_disposition.py:418:        call_site_patterns=["should_reject_preopen_cash("],; tools\hook_migration_acceptance.py:130:    def should_reject_preopen_cash(self, date_key, time_key, available_cash):; tools\hook_migration_acceptance.py:131:        reject, threshold = self._base.should_reject_preopen_cash(date_key, time_key, available_cash); tools\hook_migration_acceptance.py:558:    reject_2025, threshold_2025 = compat.should_reject_preopen_cash("2025-03-19", "09:28", 19999.99)`
- target_owner: `jq_archive`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:108:    def should_reject_preopen_order(self, date_key, security):; rebuild_from_archive/engine\core.py:487:            and self.compat.should_reject_preopen_order(date_key, security)`
- Secondary references: `tools\audit_hook_disposition.py:442:        call_site_patterns=["should_reject_preopen_order("],; tools\hook_migration_acceptance.py:135:    def should_reject_preopen_order(self, date_key, security):; tools\hook_migration_acceptance.py:136:        reject = self._base.should_reject_preopen_order(date_key, security)`
- target_owner: `jq_archive`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:111:    def should_drop_first_preopen_duplicate(self, date_key, security):; rebuild_from_archive/engine\core.py:505:            or not self.compat.should_drop_first_preopen_duplicate(date_key, order.security)`
- Secondary references: `tools\audit_hook_disposition.py:466:        call_site_patterns=["should_drop_first_preopen_duplicate("],; tools\hook_migration_acceptance.py:140:    def should_drop_first_preopen_duplicate(self, date_key, security):; tools\hook_migration_acceptance.py:141:        drop = self._base.should_drop_first_preopen_duplicate(date_key, security); tools\hook_migration_acceptance.py:536:    dup = compat.should_drop_first_preopen_duplicate("2021-12-01", "600072.XSHG")`
- target_owner: `jq_archive`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:94:    def get_execution_price_override(self, date_key, time_key, security, side):; rebuild_from_archive/engine\core.py:1133:                override = self.compat.get_execution_price_override(day_key, norm_time, security, side)`
- Secondary references: `tools\audit_hook_disposition.py:490:        call_site_patterns=["get_execution_price_override("],; tools\hook_migration_acceptance.py:115:    def get_execution_price_override(self, date_key, time_key, security, side):; tools\hook_migration_acceptance.py:116:        value = self._base.get_execution_price_override(date_key, time_key, security, side); tests\test_compat_entrypoints.py:12:    assert compat.get_execution_price_override("20230323", "09:30", "600518.XSHG", "buy") == 2.16`
- target_owner: `jq_archive`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:98:    def get_order_amount_override(self, date_key, time_key, security):; rebuild_from_archive/engine\core.py:1147:                override = self.compat.get_order_amount_override(day_key, norm_time, security)`
- Secondary references: `tests\test_compat_entrypoints.py:17:    assert compat.get_order_amount_override("20200518", "09:26", "000987.XSHE") == [38600, 33800]; tools\audit_hook_disposition.py:514:        call_site_patterns=["get_order_amount_override("],; tools\hook_migration_acceptance.py:120:    def get_order_amount_override(self, date_key, time_key, security):; tools\hook_migration_acceptance.py:121:        value = self._base.get_order_amount_override(date_key, time_key, security)`
- target_owner: `jq_archive`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:101:    def get_fill_amount_override(self, date_key, time_key, security):; rebuild_from_archive/engine\core.py:1174:                override = self.compat.get_fill_amount_override(day_key, norm_time, security)`
- Secondary references: `tests\test_compat_entrypoints.py:18:    assert compat.get_fill_amount_override("20200416", "09:30", "002041.XSHE") == 39300; tools\audit_hook_disposition.py:538:        call_site_patterns=["get_fill_amount_override("],; tools\hook_migration_acceptance.py:125:    def get_fill_amount_override(self, date_key, time_key, security):; tools\hook_migration_acceptance.py:126:        value = self._base.get_fill_amount_override(date_key, time_key, security)`
- target_owner: `jq_archive`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:149:    def apply_call_auction_overrides(self, frame):; rebuild_from_archive/engine\data_api.py:759:            df = self.compat.apply_call_auction_overrides(df)`
- Secondary references: `tests\test_compat_entrypoints.py:31:    out = compat.apply_call_auction_overrides(frame); tools\audit_hook_disposition.py:562:        call_site_patterns=["apply_call_auction_overrides("],; tools\audit_hook_disposition.py:586:        call_site_patterns=["apply_call_auction_overrides("],; tools\audit_hook_disposition.py:610:        call_site_patterns=["apply_call_auction_overrides("],; tools\hook_migration_acceptance.py:176:    def apply_call_auction_overrides(self, frame):; tools\hook_migration_acceptance.py:178:        out = self._base.apply_call_auction_overrides(frame)`
- target_owner: `investigation`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:149:    def apply_call_auction_overrides(self, frame):; rebuild_from_archive/engine\data_api.py:759:            df = self.compat.apply_call_auction_overrides(df)`
- Secondary references: `tests\test_compat_entrypoints.py:31:    out = compat.apply_call_auction_overrides(frame); tools\hook_migration_acceptance.py:176:    def apply_call_auction_overrides(self, frame):; tools\hook_migration_acceptance.py:178:        out = self._base.apply_call_auction_overrides(frame); tools\audit_hook_disposition.py:562:        call_site_patterns=["apply_call_auction_overrides("],; tools\audit_hook_disposition.py:586:        call_site_patterns=["apply_call_auction_overrides("],; tools\audit_hook_disposition.py:610:        call_site_patterns=["apply_call_auction_overrides("],`
- target_owner: `investigation`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:149:    def apply_call_auction_overrides(self, frame):; rebuild_from_archive/engine\data_api.py:759:            df = self.compat.apply_call_auction_overrides(df)`
- Secondary references: `tools\audit_hook_disposition.py:562:        call_site_patterns=["apply_call_auction_overrides("],; tools\audit_hook_disposition.py:586:        call_site_patterns=["apply_call_auction_overrides("],; tools\audit_hook_disposition.py:610:        call_site_patterns=["apply_call_auction_overrides("],; tools\hook_migration_acceptance.py:176:    def apply_call_auction_overrides(self, frame):; tools\hook_migration_acceptance.py:178:        out = self._base.apply_call_auction_overrides(frame); tests\test_compat_entrypoints.py:31:    out = compat.apply_call_auction_overrides(frame)`
- target_owner: `investigation`
...
- Secondary references: `tools\hook_migration_acceptance.py:171:    def get_security_start_date_override(self, security):; tools\hook_migration_acceptance.py:172:        value = self._base.get_security_start_date_override(security); tools\hook_migration_acceptance.py:506:        start_override = compat.get_security_start_date_override(case["code"]); tools\audit_hook_disposition.py:634:        call_site_patterns=["get_security_start_date_override("],`
- target_owner: `hdata`
...
- Secondary references: `tools\audit_hook_disposition.py:658:        call_site_patterns=["apply_security_name_overrides("],; tools\audit_hook_disposition.py:682:        call_site_patterns=["apply_security_name_overrides("],; tools\hook_migration_acceptance.py:188:    def apply_security_name_overrides(self, api, out, date):; tools\hook_migration_acceptance.py:190:        result = self._base.apply_security_name_overrides(api, out, date); alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:394:+            return self.compat.apply_security_name_overrides(self, out, date)`
- target_owner: `hdata`
...
- Secondary references: `tools\audit_hook_disposition.py:709:        call_site_patterns=["adjust_extras_is_st("],; tools\hook_migration_acceptance.py:199:    def adjust_extras_is_st(self, api, security, date, is_st):; tools\hook_migration_acceptance.py:200:        value = self._base.adjust_extras_is_st(api, security, date, is_st); alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:633:+                is_st = self.compat.adjust_extras_is_st(self, s, ds_dt, is_st)`
- target_owner: `hdata`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:369:    def filter_billboard_rows(self, frame):; rebuild_from_archive/engine\data_api.py:1073:                df = self.compat.filter_billboard_rows(df)`
- Secondary references: `tools\hook_migration_acceptance.py:204:    def filter_billboard_rows(self, frame):; tools\hook_migration_acceptance.py:205:        out = self._base.filter_billboard_rows(frame); alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:649:+                df = self.compat.filter_billboard_rows(df); tools\audit_hook_disposition.py:736:        call_site_patterns=["filter_billboard_rows("],; tools\run_counterfactual_2024_000506_billboard_filter.py:29:    def filter_billboard_rows(self, frame):; tools\run_counterfactual_2024_000506_billboard_filter.py:30:        frame = super().filter_billboard_rows(frame)`
- target_owner: `investigation`
...
- Secondary references: `tests\test_compat_entrypoints.py:52:    fallback = compat.get_instrument_price_fallback("511880.XSHG", end_date="2024-01-02"); tools\audit_hook_disposition.py:760:        call_site_patterns=["get_instrument_price_fallback("],; tools\hook_migration_acceptance.py:151:    def get_instrument_price_fallback(self, security, start_date=None, end_date=None):; tools\hook_migration_acceptance.py:152:        value = self._base.get_instrument_price_fallback(security, start_date=start_date, end_date=end_date)`
- target_owner: `hdata`
...
- Runtime call sites: `母版-20260506-Clone.py:266:    apply_project_strategy_compat("after_fb_state", context, g); 母版-20260506-Clone.py:271:    apply_project_strategy_compat("after_v227_shock", context, g); rebuild_from_archive/project_compat.py:75:            "apply_project_strategy_compat": lambda stage, context, state=None: self.apply_strategy_state_override(; rebuild_from_archive/project_compat.py:174:    def apply_strategy_state_override(self, stage, context, state=None):`
- Secondary references: `tools\audit_hook_disposition.py:796:        evidence="母版-20260506-Clone.py calls apply_project_strategy_compat('after_fb_state', ...) and project_compat.apply_strategy_state_override applies FB_STATE_OVERRIDES.",; tools\audit_hook_disposition.py:808:        call_site_patterns=["apply_project_strategy_compat(", "apply_strategy_state_override("],; tools\audit_hook_disposition.py:820:        evidence="母版-20260506-Clone.py calls apply_project_strategy_compat('after_v227_shock', ...) and project_compat.apply_strategy_state_override applies V227_SHOCK_OVERRIDES.",; tools\audit_hook_disposition.py:832:        call_site_patterns=["apply_project_strategy_compat(", "apply_strategy_state_override("],; tools\audit_hook_disposition.py:969:        evidence="Engine.__init__ merges compat.namespace_entries(self), and 母版-20260506-Clone.py calls apply_project_strategy_compat(...) at fixed stages.",; tools\audit_hook_disposition.py:981:        call_site_patterns=["namespace_entries(", "apply_project_strategy_compat("],; alignment_reports\compat_hook_migration_report.md:11:- `母版-20260506-Clone.py` 的策略状态兼容已改为 `apply_project_strategy_compat(...)` 单入口；; alignment_reports\compat_hook_migration_report.md:54:当前运行时代码中，兼容事实应通过 `EmotionGateJQCompat` 或 `apply_project_strategy_compat(...)` 暴露，不再由调用点各自维护散落字典。; tests\test_compat_entrypoints.py:43:    compat.apply_strategy_state_override("after_fb_state", context, state); tests\test_compat_entrypoints.py:49:    compat.apply_strategy_state_override("after_v227_shock", context2, state); tools\hook_migration_acceptance.py:88:        entries['apply_project_strategy_compat'] = lambda stage, context, state=None: self.apply_strategy_state_override(stage, context, state); tools\hook_migration_acceptance.py:145:    def apply_strategy_state_override(self, stage, context, state=None):; tools\hook_migration_acceptance.py:146:        value = self._base.apply_strategy_state_override(stage, context, state); tools\hook_migration_acceptance.py:541:    override = compat.apply_strategy_state_override("after_v227_shock", context, state)`
- target_owner: `jq_archive`
...
- semantic_type / disposition / status: `project_logic` / `retain_in_project` / `retain`
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:224:    def load_first_seal_year(self, year):; rebuild_from_archive/engine\data_api.py:820:            return self.compat.load_first_seal_year(year); 母版-20260506-Clone.py:798:            sealing_times = get_batch_sealing_points(g.yjj_candidates, yday); rebuild_from_archive/engine\data_api.py:838:    def get_batch_sealing_points(self, securities, date):`
- Secondary references: `tools\audit_hook_disposition.py:298:        call_site_patterns=["should_bypass_history_fastpath(", "load_first_seal_year(", "get_project_board_snapshot("],; tools\audit_hook_disposition.py:856:        call_site_patterns=["load_first_seal_year(", "get_batch_sealing_points("],; alignment_reports\alignment_summary_2020_2026.md:205:- `load_first_seal_year()` 在污染窗口跳过对应快缓存。; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:462:+            return self.compat.load_first_seal_year(year); alignment_reports\alignment_final_report_2020_2026.md:193:  - `get_batch_sealing_points()` 改走 `get_price(... panel=False)`; alignment_reports\alignment_final_report_2020_2026.md:318:- `get_batch_sealing_points()` 改走可控路径; alignment_reports\alignment_summary_2020_2026.md:212:- `get_batch_sealing_points()` 改为使用 `get_price(... fields=['high_limit'], panel=False)`，避免直接依赖 `_history_cached(...)` 旧路径。; alignment_reports\alignment_summary_2020_2026.md:396:- `get_batch_sealing_points()` 从直接用底层缓存，改为走可控的 `get_price(... panel=False)`；; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:525:     def get_batch_sealing_points(self, securities, date):; tools\hook_migration_acceptance.py:529:    tail = api.get_batch_sealing_points(["000420.XSHE"], "2021-11-15").get("000420.XSHE"); alignment_reports\alignment_configuration_notes.md:166:### 3.3 `get_batch_sealing_points()``
...
- Trigger codes: ``
- Effects: selection=yes, state=yes, order=no, fill=no, nav=no
- Reason: Board snapshot is a project-derived feature, so its runtime accessor belongs to the project layer.
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:67:                engine.data_api.get_project_board_snapshot(*a, **kw); rebuild_from_archive/project_compat.py:247:    def get_project_board_snapshot(self, date):; 母版-20260506-Clone.py:564:        board_df = get_project_board_snapshot(context.previous_date); 母版-20260506-Clone.py:666:        board_df = get_project_board_snapshot(context.previous_date); rebuild_from_archive/engine\data_api.py:823:    def get_project_board_snapshot(self, date):; rebuild_from_archive/engine\data_api.py:825:            return self.compat.get_project_board_snapshot(date)`
- Secondary references: `tools\audit_hook_disposition.py:298:        call_site_patterns=["should_bypass_history_fastpath(", "load_first_seal_year(", "get_project_board_snapshot("],; tools\audit_hook_disposition.py:869:        evidence="母版-20260506-Clone.py reads get_project_board_snapshot(context.previous_date) for board scans; engine/data_api.py delegates through compat.",; tools\audit_hook_disposition.py:881:        call_site_patterns=["get_project_board_snapshot("],; alignment_reports\alignment_summary_2020_2026.md:206:- `get_project_board_snapshot()` 在污染窗口直接返回空 `DataFrame()`，避免使用脏首板快照。; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:232:-            'get_project_board_snapshot': lambda *a, **kw: self._wrap_pandas(self.data_api.get_project_board_snapshot(*a, **kw)),; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:465:     def get_project_board_snapshot(self, date):; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:481:+            return self.compat.get_project_board_snapshot(date)`
- target_owner: `emotion_gating_project`
...
- Trigger codes: ``
- Effects: selection=yes, state=yes, order=no, fill=no, nav=no
- Reason: This is a project-derived feature accessor, not a generic market or account behavior.
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:70:                engine.data_api.get_project_master_prepare_index(*a, **kw); rebuild_from_archive/project_compat.py:256:    def get_project_master_prepare_index(self, date):; rebuild_from_archive/engine\data_api.py:828:    def get_project_master_prepare_index(self, date):; rebuild_from_archive/engine\data_api.py:830:            return self.compat.get_project_master_prepare_index(date)`
- Secondary references: `tools\audit_hook_disposition.py:906:        call_site_patterns=["get_project_master_prepare_index("],; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:233:-            'get_project_master_prepare_index': lambda *a, **kw: self._wrap_pandas(self.data_api.get_project_master_prepare_index(*a, **kw)),; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:484:     def get_project_master_prepare_index(self, date):; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:500:+            return self.compat.get_project_master_prepare_index(date)`
- target_owner: `emotion_gating_project`
- handoff_requirement: Retain while master_prepare_index remains a project-level feature artifact.
...
- Trigger codes: ``
- Effects: selection=yes, state=yes, order=no, fill=no, nav=no
- Reason: This accessor is specific to the project’s derived candidate-preparation feature set.
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:73:                engine.data_api.get_project_auction_yiqian_prepare(*a, **kw); rebuild_from_archive/project_compat.py:263:    def get_project_auction_yiqian_prepare(self, date):; 母版-20260506-Clone.py:1058:        cached = get_project_auction_yiqian_prepare(context.current_dt); rebuild_from_archive/engine\data_api.py:833:    def get_project_auction_yiqian_prepare(self, date):; rebuild_from_archive/engine\data_api.py:835:            return self.compat.get_project_auction_yiqian_prepare(date)`
- Secondary references: `tools\audit_hook_disposition.py:919:        evidence="母版-20260506-Clone.py reads get_project_auction_yiqian_prepare(context.current_dt), and project_compat.get_project_auction_yiqian_prepare also runs project-specific left-pressure logic.",; tools\audit_hook_disposition.py:931:        call_site_patterns=["get_project_auction_yiqian_prepare("],; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:234:-            'get_project_auction_yiqian_prepare': lambda *a, **kw: self._wrap_pandas(self.data_api.get_project_auction_yiqian_prepare(*a, **kw)),; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:503:     def get_project_auction_yiqian_prepare(self, date):; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:522:+            return self.compat.get_project_auction_yiqian_prepare(date)`
- target_owner: `emotion_gating_project`
...
- Trigger codes: ``
- Effects: selection=yes, state=no, order=no, fill=no, nav=no
- Reason: This is a project cache integration point for a derived feature layout.
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:288:    def load_project_call_auction_day(self, api, day):; rebuild_from_archive/engine\data_api.py:806:            out = self.compat.load_project_call_auction_day(self, day)`
- Secondary references: `tools\audit_hook_disposition.py:956:        call_site_patterns=["load_project_call_auction_day("],; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:404:-        out = self._load_project_call_auction_day(day); alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:407:+            out = self.compat.load_project_call_auction_day(self, day); alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:415:-    def _load_project_call_auction_day(self, day):`
- target_owner: `emotion_gating_project`
...
- Trigger codes: ``
- Effects: selection=yes, state=yes, order=no, fill=no, nav=no
- Reason: Namespace wiring is project infrastructure that allows strategy code to call project-owned compatibility services.
...
- Runtime call sites: `rebuild_from_archive/project_compat.py:64:    def namespace_entries(self, engine):; rebuild_from_archive/engine\core.py:222:            self.namespace.update(self.compat.namespace_entries(self)); 母版-20260506-Clone.py:266:    apply_project_strategy_compat("after_fb_state", context, g); 母版-20260506-Clone.py:271:    apply_project_strategy_compat("after_v227_shock", context, g)`
- Secondary references: `tools\audit_hook_disposition.py:969:        evidence="Engine.__init__ merges compat.namespace_entries(self), and 母版-20260506-Clone.py calls apply_project_strategy_compat(...) at fixed stages.",; tools\audit_hook_disposition.py:981:        call_site_patterns=["namespace_entries(", "apply_project_strategy_compat("],; tools\hook_migration_acceptance.py:86:    def namespace_entries(self, engine):; tools\hook_migration_acceptance.py:87:        entries = self._base.namespace_entries(engine) if hasattr(self._base, 'namespace_entries') else {}; alignment_reports\align_worktree_diff_2020-01-02_2021-12-31.patch:243:+            self.namespace.update(self.compat.namespace_entries(self)); tools\audit_hook_disposition.py:796:        evidence="母版-20260506-Clone.py calls apply_project_strategy_compat('after_fb_state', ...) and project_compat.apply_strategy_state_override applies FB_STATE_OVERRIDES.",; tools\audit_hook_disposition.py:808:        call_site_patterns=["apply_project_strategy_compat(", "apply_strategy_state_override("],; tools\audit_hook_disposition.py:820:        evidence="母版-20260506-Clone.py calls apply_project_strategy_compat('after_v227_shock', ...) and project_compat.apply_strategy_state_override applies V227_SHOCK_OVERRIDES.",; tools\audit_hook_disposition.py:832:        call_site_patterns=["apply_project_strategy_compat(", "apply_strategy_state_override("],; alignment_reports\compat_hook_migration_report.md:11:- `母版-20260506-Clone.py` 的策略状态兼容已改为 `apply_project_strategy_compat(...)` 单入口；; alignment_reports\compat_hook_migration_report.md:54:当前运行时代码中，兼容事实应通过 `EmotionGateJQCompat` 或 `apply_project_strategy_compat(...)` 暴露，不再由调用点各自维护散落字典。`
- target_owner: `emotion_gating_project`
...
- Reason: This is a project warm-start/checkpoint integration hook, not a JQ historical fact bundle.
...
- Runtime call sites: `rebuild_from_archive/engine\core.py:230:    def set_resume_state(self, state):; rebuild_from_archive/engine\core.py:234:    def _apply_resume_state(self):; rebuild_from_archive/engine\core.py:1573:        self._apply_resume_state(); rebuild_from_archive/engine\core.py:133:        # EMOTION_GATE_COMPAT_HOOK:; rebuild_from_archive/engine\core.py:231:        """EMOTION_GATE_COMPAT_HOOK: install an application checkpoint state."""; rebuild_from_archive/engine\core.py:235:        """EMOTION_GATE_COMPAT_HOOK: restore portfolio and strategy globals."""`
- Secondary references: `tools\audit_hook_disposition.py:994:        evidence="engine/core.py marks the resume hook with EMOTION_GATE_COMPAT_HOOK comments and tools/run_counterfactual_2024_000506_billboard_filter.py uses engine.set_resume_state(...).",; tools\audit_hook_disposition.py:1006:        call_site_patterns=["set_resume_state(", "_apply_resume_state(", "EMOTION_GATE_COMPAT_HOOK"],; tools\run_counterfactual_2024_000506_billboard_filter.py:53:    engine.set_resume_state(load_engine_checkpoint(CHECKPOINT)); tools\audit_hook_disposition.py:1004:        acceptance_test="Inventory scan of EMOTION_GATE_COMPAT_HOOK sites and manual workflow reference in tools/run_counterfactual_2024_000506_billboard_filter.py",`
- target_owner: `emotion_gating_project`
...
- Runtime call sites: ``
- Secondary references: `tools\audit_hook_disposition.py:1031:        call_site_patterns=["from rebuild_from_archive.data_api", "import rebuild_from_archive.data_api", "rebuild_from_archive/data_api.py"],; tools\audit_hook_disposition.py:57:    "rebuild_from_archive/data_api.py",; tools\audit_hook_disposition.py:69:    "rebuild_from_archive/data_api.py",; tools\audit_hook_disposition.py:1013:        data_obj={"legacy_entrypoint": "rebuild_from_archive/data_api.py"},; tools\audit_hook_disposition.py:1019:        evidence="rebuild_from_archive/data_api.py dynamically loads rebuild_from_archive/legacy/data_api_legacy.py; legacy/README.md lists only the public shim as a known in-repo caller.",; tools\hook_migration_acceptance.py:599:            "status": "Legacy public entry retained via rebuild_from_archive/data_api.py shim; current in-repo caller set is the shim itself, and no suspected_unused runtime dependency remains.",; rebuild_from_archive/legacy\README.md:9:  re-exported by the public `rebuild_from_archive/data_api.py` shim.; rebuild_from_archive/legacy\README.md:13:- `rebuild_from_archive/data_api.py` public shim.; rebuild_from_archive/legacy\README.md:19:- the `rebuild_from_archive/data_api.py` shim is deleted;; alignment_reports\compat_hook_migration_report.md:60:- `rebuild_from_archive/data_api.py` (shim); alignment_reports\compat_hook_migration_report.md:81:- 尚未清理 `rebuild_from_archive/data_api.py` (shim) 这份归档平行实现；`
- target_owner: `emotion_gating_project`
...
- semantic_type / disposition / status: `unknown` / `archive_jq_only` / `archive_candidate`
...
- Runtime call sites: ``
- Secondary references: `tools\audit_hook_disposition.py:1057:            "from rebuild_from_archive.engine.temporary_fallbacks import",; tools\audit_hook_disposition.py:1058:            "import rebuild_from_archive.engine.temporary_fallbacks",`
- target_owner: `jq_archive`
